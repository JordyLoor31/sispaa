                ...
                <DialogContent>
                    <form class="space-y-6" @submit="deleteUser">
                        <DialogHeader class="space-y-3">
                            ...
                            <DialogDescription>
                                Una vez que tu cuenta sea eliminada, todos sus recursos y datos también se eliminarán de forma permanente. Por favor ingresa tu contraseña para confirmar que deseas eliminar permanentemente tu cuenta.
                            </DialogDescription>
                        </DialogHeader>
