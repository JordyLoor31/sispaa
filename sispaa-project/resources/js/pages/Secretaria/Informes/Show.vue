        ...
        <div class="flex h-full flex-1 flex-col gap-4 p-4 sm:gap-6 sm:p-6 bg-[var(--sispaa-background)]">
            <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-xl font-bold tracking-tight text-[var(--sispaa-text)] sm:text-2xl">{{ informe.materia }}</h1>
            ...
            <div class="max-w-2xl w-full mx-auto grid gap-4 sm:gap-6 sm:grid-cols-2">
                ...
                <div class="rounded-2xl p-6 shadow-sm bg-[var(--sispaa-surface)]">
                    ...
                    <p class="mt-2 text-sm font-semibold text-[var(--sispaa-text)]">{{ informe.docente.name }}</p>
                    <p class="text-xs opacity-50 text-[var(--sispaa-text)]">{{ informe.docente.email }}</p>
                </div>
            </div>
            ...
            <div class="max-w-2xl w-full mx-auto rounded-2xl p-6 shadow-sm bg-[var(--sispaa-surface)]">
                ...
                <a v-if="informe.ver_url" :href="informe.ver_url" target="_blank"
                    class="inline-flex items-center gap-1 rounded-lg px-2.5 py-1.5 text-xs font-semibold text-[var(--sispaa-primary)] hover:opacity-80 border border-[color:color-mix(in_srgb,var(--sispaa-primary)_35%,transparent)]">
