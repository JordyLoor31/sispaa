        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-6 bg-slate-50/50 dark:bg-slate-900/50">
            <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-2xl font-extrabold tracking-tight text-slate-900 dark:text-white">{{ silabo.materia }}</h1>
            ...
            <div class="max-w-2xl w-full grid gap-6 md:grid-cols-2">
                ...
                <div class="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-950">
                    ...
                    <p class="mt-2 text-sm font-semibold text-slate-800 dark:text-slate-200">{{ silabo.docente.name }}</p>
                    <p class="text-xs text-slate-400">{{ silabo.docente.email }}</p>
                </div>
            </div>
