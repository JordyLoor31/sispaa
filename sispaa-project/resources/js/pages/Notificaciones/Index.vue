...
const markAsRead = () => {
    form.post(route('notificaciones.read'), {
        preserveScroll: true,
    });
};

const hasUnread = () => props.notificaciones.some((n) => !n.leido);
</script>
            ...
            <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                        Novedades y cambios de estado sobre tus sílabos, informes y demás trámites.
                    </p>
                </div>
                <button
                    v-if="hasUnread()"
