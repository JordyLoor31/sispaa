    ...
    <AppSidebarLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="flex h-full flex-1 flex-col gap-4 p-4 sm:gap-6 sm:p-6 bg-[color:color-mix(in_srgb,var(--sispaa-surface)_30%,var(--sispaa-background))]">
            ...
            <div class="grid grid-cols-2 gap-4 sm:grid-cols-4">
                ...
                <div class="rounded-2xl border p-5 shadow-sm bg-[var(--sispaa-background)] border-[color:color-mix(in_srgb,var(--sispaa-text)_12%,transparent)]">
                    <p class="text-xs font-semibold uppercase text-[color:color-mix(in_srgb,#E4BC57_55%,var(--sispaa-text))]">En ejecución</p>
                    <p class="mt-1 text-3xl font-extrabold text-[color:color-mix(in_srgb,#E4BC57_55%,var(--sispaa-text))]">{{ stats.en_ejecucion }}</p>
                </div>
                <div class="rounded-2xl border p-5 shadow-sm bg-[var(--sispaa-background)] border-[color:color-mix(in_srgb,var(--sispaa-text)_12%,transparent)]">
                ...
                <div class="rounded-2xl border p-5 shadow-sm bg-[var(--sispaa-background)] border-[color:color-mix(in_srgb,var(--sispaa-text)_12%,transparent)]">
                    <p class="text-xs font-semibold uppercase text-rose-600">Canceladas</p>
                    <p class="mt-1 text-3xl font-extrabold text-rose-600">{{ stats.canceladas }}</p>
                </div>
            </div>
